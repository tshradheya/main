...
This portfolio showcases the features and enhancements I have contributed to iContacts, lists the enhancement proposed for the upcoming features, and also includes other contributions I have made.
...
* Users will be able to list all tags that the users have used when adding or editing the contacts.
...
* Since the nickname is just another field for the contact, it would make sense to combine it with the `add` and `edit` command.
