...
* Found 4 bugs during acceptance testing link:https://github.com/CS2103AUG2017-T17-B4/main/issues?utf8=%E2%9C%93&q=is%3Aissue%20author%3Atshradheya%20[`Issues Created`]
