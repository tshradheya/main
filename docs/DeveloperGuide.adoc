...
==== Model component
The `Model` component handles the contacts in iContacts and all its stored details in data structures which provide API to create, read, update and delete the contacts. The figure below (Refer to Figure 9) shows the structure of the `Model` component.
