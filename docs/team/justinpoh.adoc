...
knowledge I have learned during the course of CS2103T, as well as how I utilized this knowledge and applied it onto a real-world
...
Currently, iContacts only notify users of an invalid command syntax after users have typed out the whole command and pressed `Enter`.
...
have to manually export the source file to share their contacts, and this can only take place if both users uses iContacts. Furthermore,
