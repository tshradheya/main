...
==== Model component
The `Model` Component handles the contacts in address book and all its stored details in data structures which provides with the API to create, read, update and delete the contacts in the address book. The figure below (Refer to Figure 9) shows the structure of the `Model` component.
...
---
=== Location mechanism
The location command is implemented in an event-driven mechanism form. The below diagram (Refer to Figure 21) shows sequence diagram for it.
