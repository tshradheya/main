...
also reminders (coming in further milestones) that users can set for themselves. The reminders would be listed
chronologically, starting with the reminders that are closest to the current date. +
Format: `toggle`
