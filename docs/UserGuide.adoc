...
Format: `addReminder REMINDER DATE TIME`
...
* `addReminder Dinner with family 25/12/2017 1800`
* `addReminder CS2105 Assignment 26/10/2017 2359`
...
* *Add Reminders* : `addReminder REMINDER DATE TIME` +
e.g. `addReminder Dinner with family 25/12/2017 1800`
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
