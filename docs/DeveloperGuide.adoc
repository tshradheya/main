...
Target User: The software is aimed to target university students to make their life easier allowing them to communicate easily with friends, family, colleagues etc
...
|`*` |busy student |I should be able to create meeting reminders with my link:#contacts[contacts] |so that I don't forget whom should I be meeting at what time
