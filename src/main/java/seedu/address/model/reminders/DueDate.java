...
public class DueDate {
    public static final String DUEDATE_FORMAT_MESSAGE = "Date must be in the format dd-mm-yyyy, dd/mm/yyyy or dd.mm.yyyy,"
    ...
    public DueDate(String userInputDate, String userInputTime) throws IllegalValueException {
        ...
        if (!isValidDueDate(userInputDate, userInputTime)) {
            throw new IllegalValueException(DUEDATE_FORMAT_MESSAGE);
        }
    ...
    /**
     * Returns true of the due date given is valid.
     */
    public static boolean isValidDueDate(String userInputDate, String userInputTime) {
