...
* If the event is going to happen today, the reminder cell is colored in red (Refer to Figure 3). +
* If the event is going to happen within three days, the reminder cell is colored in yellow (Refer Figure 4). +
* If the event is going to happen more than three days away, the reminder cell is colored in green (Refer to Figure 5).
****

image::ReminderToday.png[width=500]
_Figure 3: Event happening today._

image::ReminderThreeDays.png[width=500]
_Figure 4: Event happening within three days._

image::ReminderNormal.png[width=500]
_Figure 5: Event not happening anytime soon._
// end::addReminder[]
...
=== Emailing to a group of people having a particular tag: `email` [V1.3]
...
Toggle between the reminders panel (Refer to Figure 12) and the browser (Refer to Figure 13) as needed. +
...
_Figure 14 : The default panel._
// end::toggle[]
